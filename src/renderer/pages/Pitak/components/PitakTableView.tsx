// components/Pitak/components/PitakTableView.tsx
              ...
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-3 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">
                    <button onClick={() => handleSort("location")} className="flex items-center gap-1 hover:text-gray-700">
                      Location
                      {sortBy === "location" && (
                  ...
                  <th className="px-3 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">
                    <button onClick={() => handleSort("totalLuwang")} className="flex items-center gap-1 hover:text-gray-700">
                      Luwang Capacity
                      {sortBy === "totalLuwang" && (
                        <ChevronRightIcon className={`w-3 h-3 transform ${sortOrder === "asc" ? "rotate-90" : "-rotate-90"}`} />
                      )}
